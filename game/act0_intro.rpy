label intro:
    ...
    "A time of political intrigue, religious unrest, and clandestine treachery."

    "The once-mighty Holy Roman Empire is engulfed in turmoil as noble families ruthlessly vie for power and influence."

    scene bg duke praying
    ...
    "11th of December 1344, Abbey of Neuberg\n(Austrian Alps, Holy Roman Empire)"

    define f = Character("Friedrich II")
    define k = Character("?????")
    ...
    scene bg horror 2 with dissolve

    f "NO-N{w=0.4}{nw}"

    scene bg horror 3 with dissolve

    f "NO-NO{w=0.4}{nw}"

    scene bg horror 4 with dissolve
